...
![](../inst/images/SeqFish_mouse_cortex/0-spatPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/11-showClusterHeatmap.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/12-showClusterDendrogram.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/13-spatDimPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/14-spatDimPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/15-violinPlot.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/16-plotMetaDataHeatmap.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/17-violinPlot.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/18-spatDimPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/19-plotHeatmap.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/20-plotHeatmap.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/21-spatPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/22-spatPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/23-spatPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/24-spatPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/25-spatPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/26-spatGenePlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/27-heatmSpatialCorFeats.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/28-rankSpatialCorGroups.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/29-spatCellPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/30-spatPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/31-cellProximityBarplot.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/32-cellProximityHeatmap.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/33-cellProximityNetwork.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/12_d_network_cell_cell_enrichment_self.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/34-cellProximitySpatPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/35-spatPlot2D.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/36-plotCellProximityGenes.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/37-plotICF.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/38-plotCCcomDotplot.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/39-plotRankSpatvsExpr.png){ width=50% }
...
![](../inst/images/SeqFish_mouse_cortex/40-plotRecovery.png){ width=50% }
