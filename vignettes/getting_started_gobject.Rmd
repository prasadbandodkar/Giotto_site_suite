...
**@dimension_reduction**   `r colorize("approach", "#6C04D0")`-`r colorize("spat_unit", "#4C94A0")`-`r colorize("method", "#F6851F")`-`r colorize("name", "#801C34")`                                                                                       `r colorize("cells", "#6C04D0")`-`r colorize("cell", "#4C94A0")`-`r colorize("pca", "#F6851F")`-`r colorize("pca", "#801C34")`                                                                                   get_dimReduction()<br>set_dimReduction()<br>showGiottoDimRed()
