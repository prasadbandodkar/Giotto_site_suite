...
This tutorial will take you through the dimension reduction and clustering capabilities of Giotto. 
...
Giotto supports both Leiden and Louvain clustering. 
```{r, eval=FALSE}
