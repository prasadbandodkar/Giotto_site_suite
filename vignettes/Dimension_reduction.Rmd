...
screePlot(testobj)
```
![](../inst/images/getting_started_figs/dimension_reduction/3-screePlot.png){ width=50% }

```{r, eval=FALSE}
# Plot a PCA
plotPCA(gobject = testobj)
```
![](../inst/images/getting_started_figs/dimension_reduction/4-PCA.png){ width=50% }
...
```
![](../inst/images/getting_started_figs/dimension_reduction/5-tSNE.png){ width=50% }
...
```
![](../inst/images/getting_started_figs/dimension_reduction/6-UMAP.png){ width=50% }
...
plotUMAP(gobject = testobj,
         ...
         point_size = 2.5)
```
![](../inst/images/getting_started_figs/dimension_reduction/7-UMAP.png){ width=50% } 
...
```
![](../inst/images/getting_started_figs/dimension_reduction/12-UMAP.png){ width=50% } 
