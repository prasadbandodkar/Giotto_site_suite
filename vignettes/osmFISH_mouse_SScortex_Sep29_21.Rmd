...
# 2. osmFISH way
raw_expr_matrix = osm_test@expression$rna$raw
...
osm_test@expression$rna$custom = norm_genes_cells
...
spatFeatPlot2D(osm_test, expression_values = 'scaled',
                  genes = kmtest$feats[1:3], dim_point_shape ='no_border',
                  plot_alignment = 'horizontal', cow_n_col = 1,
