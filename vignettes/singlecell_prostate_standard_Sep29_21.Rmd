...
```{r eval=FALSE}
giotto_SC<-createGiottoObject(expression = get10Xmatrix("/restricted/projectnb/camplab/home/junxiang/souporcell_test/Aggr/outs/count/filtered_feature_bc_matrix", 
...
library(rtracklayer)
gtf <- import("Homo_sapiens.GRCh38.101.gtf.gz")
...
![](../inst/images/singlecell_prostate_standard/vignette_sep29_2021/3_scree_plot.png){ width=50% }
...
![](../inst/images/singlecell_prostate_standard/vignette_sep29_2021/4_Cluster.png){ width=50% }
...
markergenes_scran = unique(markers_scran[, head(.SD, 3), by="cluster"][["genes"]])
...
```
![](../inst/images/singlecell_prostate_standard/vignette_sep29_2021/5_a_metaheatmap.png){ width=50% }

```{r eval = FALSE}
topgenes_scran = markers_scran[, head(.SD, 1), by = 'cluster']$genes
# violinplot
violinPlot(giotto_SC, genes = unique(topgenes_scran), cluster_column = 'leiden_clus',
           strip_text = 10, strip_position = 'right',
           save_param = list(save_name = '5_b_violinplot_scran', base_width = 5))

```
![](../inst/images/singlecell_prostate_standard/vignette_sep29_2021/5_b_violinplot_scran.png){ width=50% }
...
```
![](../inst/images/singlecell_prostate_standard/vignette_sep29_2021/6_featureplot.png){ width=50% }
...
```
![](../inst/images/singlecell_prostate_standard/vignette_sep29_2021/7_Annotation.png){ width=50% }
...
```
![](../inst/images/singlecell_prostate_standard/vignette_sep29_2021/8a_scree_plot.png){ width=50% }
...
![](../inst/images/singlecell_prostate_standard/vignette_sep29_2021/8b_Cluster.png){ width=50% }


```{r eval = FALSE}
markers_scran_T = findMarkers_one_vs_all(gobject=Subset_giotto_T, method="scran",
                                       expression_values="normalized", cluster_column='leiden_clus', min_feats=3)
markergenes_scran_T = unique(markers_scran_T[, head(.SD, 5), by="cluster"][["genes"]])
...
```
![](../inst/images/singlecell_prostate_standard/vignette_sep29_2021/8_c_metaheatmap.png){ width=50% }
...
![](../inst/images/singlecell_prostate_standard/vignette_sep29_2021/8d_Annotation.png){ width=50% }
