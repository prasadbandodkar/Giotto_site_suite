...
spatInSituPlotPoints(fov_join,
                     ...
                     background_color = NA)
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1272022/Rplot1.png){ width=175% }
...
spatPlot2D(gobject = fov_join,
           ...
           coord_fix_ratio = 1)
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1272022/Rplot2.png){ width=150% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1262022/Rplothist.png){ width=50% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1272022/Rplot3.png){ width=150% }
...
spatInSituPlotPoints(fov_join,
                     ...
                     coord_fix_ratio = T)
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1272022/Rplot5.png){ width=150% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/4-HVFplot.png){ width=50% }
...
fov_join <- calculateHVF(gobject = fov_join,
                         ...
                         show_plot = T)
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/5-HVFplot.png){ width=50% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/6-screePlot.png){ width=50% }
...
plotPCA(fov_join,
        ...
        dim2_to_use = 2)
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/7-PCA.png){ width=50% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/8-UMAP.png){ width=50% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/9-UMAP.png){ width=50% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/10-spatDimPlot2D.png){ width=50% }
...
spatInSituPlotPoints(fov_join,
                     ...
                     coord_fix_ratio = TRUE)
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1272022/spatinsituclustered.png){ width=150% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/12-spatInSituPlotPoints.png){ width=75% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/13-spatFeatPlot2D.png){ width=50% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/14-violinPlot.png){ width=50% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1262022/6-plotMetaDataHeatmap.png){ width=50% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/15-UMAP.png){ width=50% }
...
spatDimPlot2D(gobject = fov_join,
              ...
              spat_point_size = 2)
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/16-spatDimPlot2D.png){ width=50% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/17-spatInSituPlotPoints.png){ width=50% }
...
```
![](../inst/images/nanostring_CosMx_Lung12/Emma/results-1252022/18-spatInSituPlotPoints.png){ width=50% }
