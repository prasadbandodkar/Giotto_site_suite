...
For instance, assume we have already created a **giottoImage** object named GImage:
...
<details>
  ...
  First create a new directory. This will be your Visium Directory. Then, open a terminal within that directory, and enter the following commands:
...
```
  ...
  This will create two subdirectories within your Visium Directory, titled "raw_feature_bc_matrix" and "spatial". These subdirectories will contain  barcode and expression information, or images and scaling information, respectively. Now, your Visium Directory may be inputted to **createGiottoVisiumObject()**!

  <hr>
</details>  

A giotto object using either the hires or lowres image will be loaded depending on whether "**tissue_hires_image.png"** or **"tissue_lowres_image.png"** is provided to the **png_name** argument. In this example, we will use and plot the hires image.  
...
```
  ![](../inst/images/getting_started_figs/getting_started_images/low_res_IT.png){width=50%}  
...
```
![](../inst/images/getting_started_figs/getting_started_images/low_res_update_manual_IT.png){width=50%}  

#### After giottoImage creation; update within the giottoObject
```{r eval=FALSE}
# createGiottoImage with manually defined adjustment values
...
```
![](../inst/images/getting_started_figs/getting_started_images/low_res_before_update_IT.png){width=50%}
```{r eval=FALSE}
...
```
![](../inst/images/getting_started_figs/getting_started_images/low_res_after_update_IT.png){width=50%}
