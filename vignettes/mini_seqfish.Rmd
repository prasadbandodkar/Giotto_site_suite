...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/0-HVFplot.png")
```
![](../inst/images/mini_seqFISH/220616_results/0-HVFplot.png){ width=50% } 
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/1-screePlot.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/2-jackstrawPlot.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/3-PCA.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/4-UMAP.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/5-tSNE.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/6-UMAP.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/7-spatDimPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/8-showClusterHeatmap.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/9-showClusterDendrogram.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/10-violinPlot.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/11-plotMetaDataHeatmap.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/12-spatDimPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/13-plotHeatmap.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/14-spatPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/15-plotStatDelaunayNetwork.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/16-spatPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/17-spatPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/18-spatFeatPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/19-spatFeatPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/20-spatFeatPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/21-heatmSpatialCorFeats.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/22-rankSpatialCorGroups.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/23-spatCellPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/24-spatPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/25-cellProximityBarplot.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/26-cellProximityHeatmap.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/27-cellProximityNetwork.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/28-cellProximityNetwork.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/29-cellProximitySpatPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/30-spatPlot2D.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/31-plotCellProximityGenes.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/32-plotICF.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/33-plotCCcomHeatmap.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/34-plotCCcomDotplot.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/35-plotRankSpatvsExpr.png")
```
...
```
```{r, echo=FALSE}
knitr::include_graphics("../inst/images/mini_seqFISH/220616_results/36-plotRecovery.png")
```
