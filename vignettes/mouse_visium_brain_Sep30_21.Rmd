...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/2_a_spatplot_image.png){ width=50% } 
```{r eval = FALSE}
# check name
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/2_b_spatplot_image_adjusted.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/2_c_in_tissue.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/2_d_spatial_locations.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/2_e_nr_genes.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/3_a_HVGplot.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/3_b_screeplot.png){ width=50% } 

```{r eval = FALSE}
plotPCA(gobject = visium_brain,
        save_param = list(save_name = '3_c_PCA_reduction'))
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/3_c_PCA_reduction.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/3_d_UMAP_reduction.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/3_e_tSNE_reduction.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/4_a_UMAP_leiden.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/5_a_covis_leiden.png){ width=50% } 
```{r eval = FALSE}
spatDimPlot(gobject = visium_brain, cell_color = 'nr_feats', color_as_factor = F,
            dim_point_size = 2, spat_point_size = 2.5,
            save_param = list(save_name = '5_b_nr_genes'))
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/5_b_nr_genes.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/5_c_DEG_subset.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/6_a_violinplot_gini.png){ width=50% } 
```{r eval = FALSE}
# cluster heatmap
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/6_b_metaheatmap_gini.png){ width=50% } 
```{r eval = FALSE}
# umap plots
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/6_c_gini_umap.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/6_d_violinplot_scran.png){ width=50% } 
```{r eval = FALSE}
# cluster heatmap
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/6_e_metaheatmap_scran.png){ width=50% } 
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/6_f_scran_umap.png){ width=50% } 
...
cell_types = colnames(PAGE_matrix_2)
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/8_grid.png){ width=50% }
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/9_a_knn_network.png){ width=50% }
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/10_a_spatial_genes_km.png){ width=50% }
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/10_b_spatial_genes_rank.png){ width=50% }
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/10_c_heatmap.png){ width=50% }
...
```
![](../inst/images/mouse_visium_brain/vignette_sep29_2021/10_d_spatPlot2D_HMRF.png){ width=50% }
