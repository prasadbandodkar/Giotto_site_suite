...
explicitly provided using **createGiottoInstructions** or a named list, which can then
be given to **createGiottoObject** as a parameter (instructions = xxx).
...
spatPlot(gobject = osm_test, 
         cell_color = 'ClusterName', point_size = 1.5,
         save_param = list(save_folder = '2_Gobject', 
                           save_name = 'original_clusters', units = 'in', 
