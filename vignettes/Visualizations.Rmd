...
This tutorial walks through the visualization capabilities of Giotto. Dimension reductions (PCAs and UMAPs), focused on within the previous tutorial, [dimension reduction](./dimension_reduction.html), will be revisited. Then explore how to create heatmaps, violin plots, and visualizations that are unique to Giotto: spatial maps and networks.
